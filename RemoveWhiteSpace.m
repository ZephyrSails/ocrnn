...
function [it_is_a_file_flag, input_filename, output_filename, w, h] = check_the_argin_infile(nargin, varargin)
% 120202: Reza
...
h = 0;
%
default_fields = {'file', 'width', 'height', 'output'};
